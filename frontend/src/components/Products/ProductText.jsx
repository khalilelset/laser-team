      ...
      <Row>
        <Col md="8">
          <div className="cat-title d-inline">
            this phon is the better phon for special work in work because
            nothink in appel clor brown
      ...
      <Row className="mt-2">
        <Col md="10">
          <div className="product-description d-inline">
            ...
            iPhone 15 lineup. Rumors point to a generally similar design across
            the board, except that the iPhone 14 Pro's shape-shifting cutout,
            known as Dynamic Island, is set to make its way across all models.
          </div>
        </Col>
      </Row>
      <Row className="mt-4">
